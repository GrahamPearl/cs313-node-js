function btnFormatter(value, row) {  
  let items = '' + value + ' ';
  items += '<button type="button" class="btn btn-primary" href="#"><i class="fa fa-envelope"></i></button>';
  ...
  $('#data-table').bootstrapTable({
    ...
    columns: [{
      ...
      formatter: function (value, row) {
        let items = '<button type="button" class="btn btn-primary" href="/google/found?isbn='+value+'"><i class="far fa-eye"></i></button>';
        items += '<button type="button" class="btn btn-danger" href="#"><i class="far fa-trash-alt"></i></button>';
        return items;
      }
    }, {
...
function find_books_all() {
  ...
  switch (task) {
    case '01':
      url += "find_book_by_isbn";
      break;
    case '02':
      url += "find_book_by_author";
      break;
    case '03':
      url += "find_book_by_title";
      break;
    default:
      url += "find_books_all";
      break;
...
function find_libraries_all() {
  ...
  switch (task) {
    case '01':
      ...
      break;
    case '02':
      url += "find_branch_by_title";
      break;
    case '03':
      url += "find_branch_by_email";
      break;
    default:
